<script lang="ts">
  ...
  import { Box, Select, Text } from '@plures/design-dojo';
  ...
  function getPlaceholder(type: TransformNode['transformType']): string {
    switch (type) {
      case 'map': return 'item * 2';
      case 'filter': return 'item > 10';
      case 'reduce': return 'acc + item';
      case 'sudolang': return '// Sudolang code';
      default: return '';
    }
  }
</script>
